...
const refreshScreen = () => {
  ...
  libraryData.forEach((book) => {
    ...
    displayArea.lastChild.appendChild(document.createElement('div'));
    displayArea.lastChild.lastChild.textContent = `Title: ${book.title}`;
    displayArea.lastChild.appendChild(document.createElement('div'));
    displayArea.lastChild.lastChild.textContent = `Author: ${book.author}`;
    displayArea.lastChild.appendChild(document.createElement('div'));
    displayArea.lastChild.lastChild.textContent = `Pages: ${book.pages}`;
    displayArea.lastChild.appendChild(document.createElement('div'));
    displayArea.lastChild.lastChild.textContent = `Read: ${book.isRead}`;
